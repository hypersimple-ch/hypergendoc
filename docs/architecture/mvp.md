...
PostgreSQL stores document index and authorization metadata, not source bodies, generated HTML, PDFs, or render records. Object storage is limited to uploaded logo and font bytes; it never stores document source, generated HTML, or PDFs.
